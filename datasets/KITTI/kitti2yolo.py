...
KITTI_BASE_DIR = '/home/xiaojianlin/Project/Butter/datasets/KITTI'
"""str: The base directory where the KITTI dataset is located."""

# IMAGE_DIR = Path(KITTI_BASE_DIR) / 'images' / 'train'
IMAGE_DIR = Path(KITTI_BASE_DIR) / 'images' / 'val'
"""Path: Directory containing KITTI training images."""

# LABEL_DIR = Path(KITTI_BASE_DIR) / 'labels_kitti' / 'train'
LABEL_DIR = Path(KITTI_BASE_DIR) / 'labels_kitti' / 'val'
...
# LABELS_DIR = Path(KITTI_BASE_DIR) / 'labels' / 'train'
LABELS_DIR = Path(KITTI_BASE_DIR) / 'labels' / 'val'
...
# Convert the original 8 object classes into the 3 target classes: Car, Pedestrian, Cyclist.
# We merge the original Car, Van, Truck, and Tram into the Car class; 
# merge Pedestrian and Person(sitting) into the current Pedestrian class;
# and keep the original Cyclist class unchanged.
# CLASSES = [
#     'Car', 'Van', 'Truck', 'Pedestrian', 'Person_sitting',
#     'Cyclist', 'Tram', 'Misc', 'DontCare'
# ]
